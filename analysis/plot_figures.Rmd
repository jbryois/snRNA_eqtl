...
ggsave(p,filename='output/figures/figure2E.png',width = 6,height=4,dpi = 300)
p
```
...
p <- n_loci %>% 
  ...
  ylab('Number of loci') + geom_text(aes(label=n),position = position_dodge(width=0.9),vjust=1.1,size=8)
...
ggsave(p,filename='output/figures/FigureSX1.png',height=6,width=9,dpi = 300)
p
```
...
ggsave(p,filename='output/figures/FigureSX2.png',width = 11,height=7,dpi = 300)
p
```

## Effect size discovery vs metabrain
...
ggsave(p,filename='output/figures/FigureSX.png',width=13,dpi=300,height=5)
p
```
...
ggsave(p,filename='output/figures/FigureSZ.png',width=10,dpi=300,height=6)
p
```
...
ggsave(p,filename=paste0('output/figures/FigureSY.png'),width=24,height=8)
p
```
