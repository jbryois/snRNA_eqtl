...
```{r}
ms_eqtl_path <- '/pstore/home/bryoisj/nord_dta/Malhotra_lab/MS_snRNAseq_genetics/output/fastql/5percCells.10ind.cov3genoPCs90expPCs.ad_ms_rosmap.cpm_all_sumstats/'
```
...
write_tsv(coloc_results_all,paste0('output/Coloc/coloc.',selected_trait,'.preprint.txt'))
```
